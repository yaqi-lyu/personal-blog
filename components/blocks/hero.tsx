...
export const Hero = ({ data, searchQuery = "", setSearchQuery }: { data: PageBlocksHero; searchQuery?: string; setSearchQuery?: (q: string) => void }) => {
...
export const heroBlockSchema: Template = {
  ...
  fields: [
    ...
    {
      type: "boolean",
      label: "Including search bar",
      name: "enableSearch",
      description:
        "Enable a search bar below the hero section to search blog posts",
    },
    {
      type: "object",
      label: "Image",
