              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {relatedPostsData.map((related: any) => (
                  <Link
                    key={related.id}
                    href={related.url}
                    className="group block p-5 bg-gradient-to-br from-zinc-950 to-red-950/10 border-2 border-red-900/30 rounded-lg transition-all duration-300 hover:border-red-700/50 hover:shadow-xl hover:shadow-red-900/20"
                  >
                    {related.heroImg && (
